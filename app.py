...
def show_predict_page():
    ...
    st.write("Predicting the **Overall Skill Rating** of a player using the skill attributes of the player.")
    ...
    st.subheader(f'💯The Actual Overall Rating of the {result} is   **{np.ravel(y.values)[0]}**')
